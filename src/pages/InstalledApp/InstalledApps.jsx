...
const InstalledApps = () => {
  const notify = () => toast.warning("App Uninstalled ! ! !");
  ...
  const handleSorting = (sortType) => {
    ...
    if (sortType === "Ascending") {
      const sortBySize = [...appList].sort((a, b) => a.size - b.size);
    ...
    <div className="w-11/12 md:w-10/12 mx-auto py-10 md:py-20">
      ...
      <div className="pb-3 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div className="dropdown dropdown-end md:dropdown-center">
          ...
          >
            <li>
              <a onClick={() => handleSorting("Ascending")}>Ascending</a>
            </li>
            <li>
              <a onClick={() => handleSorting("Descending")}>Descending</a>
            </li>
          </ul>
        </div>
      </div>
